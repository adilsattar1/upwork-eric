...
<body>
   ...
   <div class="main-content">
      <section id="iq-favorites">
         <div class="pt-0">
            <video id="my-video" class="video-js vjs-big-play-centered w-100" controls="" autoplay="">
                <source src="http://admin.fitdrama.testdemolink.com/stream/trailer.mp4" type="video/mp4">
                <source src="MY_VIDEO" type="video/webm">
            </video>
        </div>
      </section>
   </div>
         ...
         <div class="container-fluid">
            <div class="row footer-standard">
               ...
               <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
                  <div class="widget text-left">
                     <div class="textwidget">
                        <h6 class="footer-link-title">Eric Egana Website</h6>
